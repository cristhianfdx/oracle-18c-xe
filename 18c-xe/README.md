...
```bash
-- Connect to CDB
sqlcl sys/7tXvhyoRXEtZnDGF@localhost:32118/XE as sysdba


-- Connect to default PDB
sqlcl sys/7tXvhyoRXEtZnDGF@localhost:32118/XEPDB1 as sysdba
```
...
First connect to the CDB as `sysdba`: `sqlcl sys/7tXvhyoRXEtZnDGF@localhost:32118/XE as sysdba`
...
sqlcl sys/7tXvhyoRXEtZnDGF@localhost:32118/XEPDB2 as sysdba
```
